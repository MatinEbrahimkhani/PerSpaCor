...
class CorpusBuilder:
    def __init__(self, tok_delim="\b", sent_delim="\n"):
        self._filehandler = CorpusHandler()
        self._corpus = {}
    ...
    def template(self, corpus_name, corpus_type: Enum):
        if corpus_name == "bijankhan":
            if corpus_type.value == CorpusType.whole_raw.value:
                pass
            elif corpus_type.value == CorpusType.whole_tok.value:
                pass
            elif corpus_type.value == CorpusType.sents_raw.value:
                pass
            elif corpus_type.value == CorpusType.sents_tok.value:
                pass
    ...
    def build_corpus(self, corpus_name, corpus_type: Enum):
        ...
        if corpus_type not in list(CorpusType):
